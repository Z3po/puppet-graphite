...
class graphite (
  ...
  $storage_schemas_conf               = "${conf_dir}/storage-schemas.conf",
  $storage_aggregation_conf           = "${conf_dir}/storage-aggregation.conf",
  $relay_rules_conf                   = "${conf_dir}/relay-rules.conf",
  $aggregation_rules_conf             = "${conf_dir}/aggregation-rules.conf",
  $whitelist_conf                     = "${conf_dir}/whitelist.conf",
  $blacklist_conf                     = "${conf_dir}/blacklist.conf",
